...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'information' in query:
            ...
            message=client.messages.create(body=takeCommand(),from_='+18595358964',to='+919625598392')
            print('Message sent successfully')
            speak('Message sent successfully')

        elif 'play music' in query:
            music_dir='C:\\Users\\Aditi\\OneDrive\\Desktop\\project 2\\music'
            ...
            spotPath='C:\\Users\\Aditi\\AppData\\Roaming\\Spotify\\Spotify.exe'
